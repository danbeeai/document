...
말풍선의 크기가 크지 않기 때문에 추가 정보는 웹페이지, 파일, 동영상 등이 될 수 있습니다. 
...
단답형으로 제공하기 어려운 정보도 있습니다. 그런 경우엔 추가적인 사용자 입력을 통해 시나리오를 진행합니다. 전화로 진행되는 ARS와 비슷합니다. 
{% include image.html file="mkt/2022/intro_11.png" caption="시나리오형 대화를 적용한 챗봇 (광주도시철도공사와 뮤지션마켓의 챗봇)" %}

### 챗봇 콘텐츠 구성요소 3-2. 대화흐름 (시나리오형-설문/접수)
여러 번의 대화 결과가 정보를 제공하는 답변이 아닌 접수 처리인 경우도 있습니다. 사용자가 이야기한 내용을 담당자에게 전달하는데요. 이와 같은 방식으로 만들 수 있는 것은 설문조사, 만족도 조사와 같은 정보 수집용 시나리오 또는 퀴즈, 이벤트 참여 신청, 세일즈 리드 생성 등이 있습니다. 

<br><br> 
수집된 정보는 담당자의 이메일이나 문자로 전달될 수도 있고 구글 스프레드시트와 같은 웹문서에 쌓을 수도 있습니다. 고객 상담 시스템이 있다면 시스템과 연계하여 처리할 수도 있겠죠?
{% include image.html file="mkt/2022/intro_12.png" caption="접수를 처리하는 챗봇 (단비AI 만족도 조사, 에이아이런의 퀴즈봇, NH농협캐피탈의 견적 챗봇" %}
...
<br><br>
일상적인 대화에 모두 답변할 수 있는 기술들도 나오고 있으나 이는 사회적으로 문제가 될 수 있는 비윤리적인 답변을 하거나 사실이 아닌 말을 답변하는 경우가 있을 수 있어 영업, 업무지원, 고객센터에서 활용되는 기업용 챗봇보다는 살아있는 듯한 캐릭터와 대화하는 느낌이 중요한 일상대화 챗봇서비스에서 많이 활용됩니다.

{% include image.html file="mkt/2022/intro_13.png" caption="기업용 챗봇과 일상 대화 챗봇" %}


## 서비스 범위와 시스템 연동 수준
챗봇에게 많은 능력을 줄 수록 해야할 일은 많아집니다. 충분한 인력과 데이터가 있다면 구글이나 애플, 아마존이 만드는 아주 똑똑한 챗봇도 만들 수 있을 것입니다. 
...
## 챗봇을 만드는 방법1. 직접 만들기
직접 챗봇을 만드는 방법과 챗봇 개발 파트너사에게 외주를 주는 방법이 있습니다. 

<br><br>
우선 직접 만드는 방법을 안내해드릴께요.
