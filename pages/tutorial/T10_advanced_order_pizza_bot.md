...
<span class="link">[Carausel Node 사용하기](/basic_carousel.html)</span> <br/>
...
<span class="link">[Slot Node 사용하기](/basic_slot.html) </span>
...
Api 설정 방법 및 Api Node 설정 방법은 위에 챕터 내용 참고해 주세요. <span class="link">[Api 설정 방법](/basic_api_node.html#api-%EB%A7%8C%EB%93%A4%EA%B8%B0)</span>
<span class="link">[Api Node 설정 방법](/basic_api_node.html#api-node-%EB%A7%8C%EB%93%A4%EA%B8%B0)</span><br/>
...
<span class="link">[Function Node 사용하기](/basic_function_node.html#function-node-%EB%A5%BC-%ED%99%9C%EC%9A%A9%ED%95%98%EC%97%AC-%EB%B3%80%EC%88%98%EA%B0%92%EC%9D%84-%EA%B0%80%EA%B3%B5%ED%95%98%EA%B8%B0) </span><br/>
...
<span class="link">[Split Node 사용하기](/basic_split.html#split-node) </span>
...
<span class="link">[Speak Node 사용하기](/basic_listen_speak.html#speak-node) </span>
