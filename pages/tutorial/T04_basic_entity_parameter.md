...
{% include image.html file="tutorial/basic03_empty_entity.png"  caption="Entity 없는 상태" %}
...
{% include image.html file="tutorial/basic03_add_entity.png"  caption="예문에 추가할 Entity 선택" %}
...
{% include image.html file="tutorial/basic03_create_parameter.png"  caption="Parameter 생성된 모습" %}
...
{% include image.html file="tutorial/basic03_parameter_list.png"  caption="Parameter 목록" %}
...
{% include image.html file="tutorial/basic03_linked_chatflow.png"  caption="연관 Chatflow" %}

2) Speak Node를 클릭하여 상세 페이지를 열어주세요.

3) 우측의 ***"Parameter 추가”*** 버튼을 클릭하면 Intent에서 설정했던 Entity가 조회됩니다. ***"피자메뉴”***를 클릭하여 Parameter를 추가해주세요.

{% include image.html file="tutorial/basic03_add_parameter.png"  caption="Speak Node 내 Parameter 추가 레이어" %}
...
{% include image.html file="tutorial/basic03_parameter_message.png"  caption="Parameter를 포함한 메시지 작성" %}
