...
## 샘플챗봇 살펴보기
지금부터는 이미 만들어져있는 챗봇들을 살펴보면서 챗봇을 만드는 요령을 더 익혀보겠습니다.
단비에이아이에 로그인한 후, 챗봇목록화면에서 "Sample Chatbot 가져오기"를 클릭하면 이미 만들어진 챗봇을 자신의 계정으로 복사해올 수 있습니다. 맨땅에서 시작하는 것보다 자신이 만들고자 하는 챗봇과 유사한 모델을 가져와서 조금씩 수정해보시기 바랍니다.
