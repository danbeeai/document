...
{% include callout.html content="화면 위치 : 챗봇 만들기 > 챗봇 제작 > 주요 대화 > 대화 의도" type="default" %}
...
### 업로드
{% include callout.html content="화면 위치 : 챗봇 만들기 > 챗봇 제작 > 주요 대화 > 대화 의도 > 대화 의도 업로드 버튼" type="default" %}
