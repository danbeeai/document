...
### 네이버톡톡 계정 만들기
1. 브라우저에서 [네이버톡톡 파트너센터](https://partner.talk.naver.com/){:target="_blank"}에 접속하십시오.
...
### 네이버톡톡 Webhook 설정
1. <span style="color:#f69023;">[네이버톡톡 파트너센터](https://partner.talk.naver.com/){:target="_blank"}</span> 의 [계정관리 홈] - [챗봇 API] - [API설정] 페이지로 돌아갑니다.
...
## 네이버톡톡 테스트
* 연결한 챗봇은 [네이버 톡톡 홈페이지](https://talk.naver.com/){:target="_blank"}의 톡톡 가맹정 찾기 또는 URL로 직접 접속하여 테스트할 수 있습니다. 
