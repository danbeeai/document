...
대화흐름 호출 버튼을 눌렀을때 각 Chatflow에서 사용되는 파라미터들끼리 연결이 가능합니다. 버튼형 <span class="link">[Jump 노드](chatflow_jump.html)</span> 기능으로 볼 수 있습니다.<br/>
...
{% include image.html file="chatflow/Chatflow_callflow_param_02.png"  caption="대화흐름 호출 파라미터 연결 팝업" %}
